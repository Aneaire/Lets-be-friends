...
export type IdentityIntent = 'member' | 'host_application'
export type IdentityReturnTo = '/app' | '/profile' | '/onboarding' | '/become-host'
...
function identityReturnPath(pathname: string, intent: IdentityIntent): IdentityReturnTo { if (pathname === '/profile' || pathname === '/onboarding' || pathname === '/become-host') return pathname; return intent === 'host_application' ? '/become-host' : '/app' }
function navigateToReturn(navigate: ReturnType<typeof useNavigate>, returnTo: IdentityReturnTo) { if (returnTo === '/profile') return navigate({ to: '/profile' }); if (returnTo === '/onboarding') return navigate({ to: '/onboarding' }); if (returnTo === '/become-host') return navigate({ to: '/become-host' }); return navigate({ to: '/app', search: {} }) }
